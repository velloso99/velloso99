...
#BLOQUEAR CPF#################################################################################
def bloquear_cpf(entrada):
    return entrada.isdigit() and len(entrada)<=11
validacao_cpf= (frame_baixo.register(bloquear_cpf), '%P')
#BLOQUEAR senha#################################################################################
def bloquear_senha(entrada):
    return entrada.isdigit() and len(entrada)<=8
validacao_senha= (frame_baixo.register(bloquear_senha), '%P')
...
e_user=Entry(frame_baixo, width=25, justify=LEFT, validate="key", validatecommand=validacao_cpf,font=("",15), highlightthickness=1, relief="solid")
...
e_senha=Entry(frame_baixo, width=25, justify=LEFT, validate="key", validatecommand=validacao_senha,font=("",15),show="*", highlightthickness=1, relief="solid")
...
#---------------------------------------------------------------------------------------------------------------------------------------------
    ...
    e_cpf=Entry(frame_baixo, width=25, justify=LEFT,validate="key", validatecommand=validacao_cpf,font=("",15), highlightthickness=1, relief="solid")
...
#BOTÕES TELA PRINCIAPAL####################################################################################################
    ...
    b_conta.grid(row=1, column=2, padx=5, pady=5, sticky=NSEW)
...
#-----------------------------------------------------------------------------------------------------------------------
    ...
    b_pesquisar = Button(frame_Centro, compound=LEFT, width=10,  text="Pesquisar", bg=co4, fg=co3, font=('Ivy 11'), overrelief=RIDGE, relief=GROOVE)
    b_pesquisar.grid(row=1, column=2, padx=5, pady=5, sticky=NSEW)
    ...
    b_conta = Button(frame_Centro, compound=LEFT, width=10, command=abrir_conta, text="Conta Virtual", bg=co4, fg=co3, font=('Ivy 11'), overrelief=RIDGE, relief=GROOVE)
    b_conta.grid(row=1, column=4, padx=5, pady=5, sticky=NSEW)
